 ...
 */
'use strict'
exports[`test/run.cjs test/fixtures/promise-no-domain.js > TAP > error 1`] = `
null

`

exports[`test/run.cjs test/fixtures/promise-no-domain.js > TAP > output 1`] = `
d caught 1
d caught 2

`

exports[`test/run.cjs test/fixtures/promise-no-domain.js > TAP > stderr 1`] = `
