 ...
 */
'use strict'
exports[`test/run.js test/fixtures/promise-rejections-unhandled-warn-with-error-code.js TAP > error 1`] = `
Object {
  "code": 1,
  "signal": null,
}
...
exports[`test/run.js test/fixtures/promise-rejections-unhandled-warn-with-error-code.js TAP > stderr 1`] = `
