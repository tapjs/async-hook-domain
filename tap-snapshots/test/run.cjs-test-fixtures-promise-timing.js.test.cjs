 ...
 */
'use strict'
exports[`test/run.cjs test/fixtures/promise-timing.js > TAP > error 1`] = `
null

`

exports[`test/run.cjs test/fixtures/promise-timing.js > TAP > output 1`] = `


`

exports[`test/run.cjs test/fixtures/promise-timing.js > TAP > stderr 1`] = `
call new Promise
